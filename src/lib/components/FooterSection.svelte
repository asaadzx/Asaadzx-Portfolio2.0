<script lang="ts">
    ...
    function resetNudge(e: MouseEvent) {
        const el = e.currentTarget as HTMLElement;
        animate(el, {
            translateX: [4, 0],
            duration: 200,
...
>
    <div class="w-full max-w-6xl 2xl:max-w-7xl mx-auto border-t border-text/10 pt-16">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 2xl:gap-12 mb-16">
            ...
            <div class="flex flex-col space-y-3">
                <span
                    class="text-xs font-bold tracking-widest text-accent uppercase"
                >
                    // INBOUND_BLOGS
                </span>
                <a
        ...
        <div
            class="w-full text-center overflow-hidden border-b border-text/5 mb-8"
        >
            <a
                href={resolve("/")}
